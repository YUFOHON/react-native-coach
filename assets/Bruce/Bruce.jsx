...
Command: npx gltfjsx@6.2.13 Bruce.glb --transform 
Files: Bruce.glb [1.03MB] > Bruce-transformed.glb [434.1KB] (58%)
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/Bruce-transformed.glb')
  return (
...
useGLTF.preload('/Bruce-transformed.glb')
